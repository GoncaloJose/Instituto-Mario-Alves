    ...
    <main className="max-w-screen-xl flex flex-col items-center mx-auto p-6">
      ...
      <div className="max-w-sm w-full">
        ...
        <form onSubmit={handleSubmit(verificaLogin)} className="space-y-6">
          ...
          <button
            type="submit"
            className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
          >
            Entrar
          </button>
        </form>
