            ...
            <div className="flex flex-col justify-between p-4">
              <div>
                ...
                <div className="text-sm text-gray-700 dark:text-gray-300 mb-3">
                  <strong className="text-gray-900 dark:text-white">Autor(es):</strong>
              ...
              <div className="flex justify-end items-center gap-3 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-800 transition-colors"
                >
                  <FaPencilAlt />
                  Editar
                </button>
