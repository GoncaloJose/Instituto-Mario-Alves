    ...
    <div className="mt-10 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5 text-center">
        ...
        <Link
          ...
          className="inline-block px-3 py-2 font-inter text-sm text-white bg-vermelho rounded-lg hover:bg-yallow-500 focus:ring-4 focus:outline-none focus:ring-red-500 dark:bg-red-500 dark:hover:bg-red-500 dark:focus:ring-red-500"
        >
          Ver Sinopse
        </Link>
